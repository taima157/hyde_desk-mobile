    ...
    function compararSenhas(){
        ...
        if(bcrypt.compareSync(comparar, senha) == true) {
            async function enviarDados() {
                ...
                // console.log(image);
                try {
                  const response = await api.put(`/tecnicos/editar/${id_tecnico}`, form);
            ...
            <Modal isVisible={visibilidade} backdropOpacity={0.1}>
                <View style={styles.modalView}>
                    ...
                    <View style={styles.containerInput}>
                        ...
                        ></TextInput>
                        {text == true ?  <Text style={styles.textSenha}>Senha incorreta</Text> : null}
                        <TouchableOpacity onPress={compararSenhas} style={styles.buttonConfirmar}>
